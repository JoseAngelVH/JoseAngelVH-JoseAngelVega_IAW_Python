# Implementar un diccionario con las notas de un alumno en las 3 evaluaciones. Con funciones.
# A) Pasar solo las notas a una sola estructura de lista con sublistas.
...
notas = {
    '1ºeval': {'Matematicas': 6, 'Lengua': 4, 'Ingles': 8, 'Informatica': 7},
    '2ºeval': {'Matematicas': 5, 'Lengua': 3, 'Ingles': 7, 'Informatica': 8},
    '3ºeval': {'Matematicas': 5, 'Lengua': 4, 'Ingles': 7, 'Informatica': 9}
}
